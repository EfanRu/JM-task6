...
//   где по получателю можно получить список зарплат, которые были ему отправлены.
    ...
    public static class Salary implements Sentable {
        private String from;
        private String to;
    ...
    public static class MailMessage implements Sentable {
        private String from;
        private String to;
    ...
    public interface Sentable<T> {
        String getTo();
        T getContent();
    }

    public static class MailService<T> implements Consumer<Sentable<T>> {
        ...
        public void accept(Sentable<T> mail) {
            if (mailBox.containsKey(mail.getTo())) {
                mailBox.get(mail.getTo()).add(mail.getContent());
            } else {
